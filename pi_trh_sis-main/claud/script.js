...
// Função que controla as perguntas e as alternativas
...
function showQuestion(index) {
    ...
    answerOptions.classList.add('grid'); // Adiciona a classe 'grid' ao container
    ...
    question.answers.forEach((answer, i) => {
        ...
        answerEl.addEventListener('click', function () {
            if (selectedAnswer) {
                // Se já houver uma resposta selecionada, reinicia seu estilo
                selectedAnswer.classList.remove('btn-primary');
                selectedAnswer.classList.add('btn-outline-primary');
            }

            // Marca o botão atual como selecionado
            selectedAnswer = answerEl;
            answerEl.classList.remove('btn-outline-primary');
            answerEl.classList.add('btn-primary');

            okBtn.classList.remove('disabled'); // Habilita o botão OK
            okBtn.addEventListener('click', () => checkAnswer(i));
        });
